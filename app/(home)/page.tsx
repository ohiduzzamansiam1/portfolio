...
export default function HomePage() {
  return (
    <div className="min-h-dvh dark:bg-black bg-white overflow-x-hidden">
      <div className="dark:bg-black bg-white bg-grid-black/[.04] dark:bg-grid-white/[0.05] relative">
      ...
      <div className="max-w-[85rem] mx-auto px-5 lg:px-14 mt-20 lg:mt-36">
        <Projects />
      </div>

      <div className="mx-auto px-5 lg:px-14 mt-20 lg:mt-36">
        <Testimonials />
      </div>
      ...
      <div className="max-w-[85rem] mx-auto px-5 lg:px-14 mt-20 mb-8">
        ...
        <p className="text-center text-gray-500 dark:text-gray-300">
          This is made by &copy;Siam_{new Date().getFullYear()}
        </p>
      </div>
    </div>
  );
